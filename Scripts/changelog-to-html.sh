...
if [[ -z "$version_content" ]]; then
  echo "<h2>Clawbar $VERSION</h2>"
  echo "<p>Latest Clawbar update.</p>"
  echo "<p><a href=\"https://github.com/steipete/Clawbar/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
