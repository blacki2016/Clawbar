...
enum KeychainMigration {
    private static let log = ClawbarLog.logger(LogCategories.keychainMigration)
    ...
    static let itemsToMigrate: [MigrationItem] = [
        MigrationItem(service: "com.steipete.Clawbar", account: "codex-cookie"),
        MigrationItem(service: "com.steipete.Clawbar", account: "claude-cookie"),
        MigrationItem(service: "com.steipete.Clawbar", account: "cursor-cookie"),
        MigrationItem(service: "com.steipete.Clawbar", account: "factory-cookie"),
        MigrationItem(service: "com.steipete.Clawbar", account: "minimax-cookie"),
        MigrationItem(service: "com.steipete.Clawbar", account: "minimax-api-token"),
        MigrationItem(service: "com.steipete.Clawbar", account: "augment-cookie"),
        MigrationItem(service: "com.steipete.Clawbar", account: "copilot-api-token"),
        MigrationItem(service: "com.steipete.Clawbar", account: "zai-api-token"),
        MigrationItem(service: "com.steipete.Clawbar", account: "synthetic-api-key"),
    ]
