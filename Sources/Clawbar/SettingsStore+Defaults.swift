...
extension SettingsStore {
    ...
    var isVerboseLoggingEnabled: Bool {
        self.debugLogLevel.rank <= ClawbarLog.Level.verbose.rank
    }
    ...
    private var claudeWebExtrasEnabledRaw: Bool {
        ...
        set {
            ...
            ClawbarLog.logger(LogCategories.settings).info(
