...
public struct ClawbarConfig: Codable, Sendable {
    ...
    public static func makeDefault(
        metadata: [UsageProvider: ProviderMetadata] = ProviderDescriptorRegistry.metadata) -> ClawbarConfig
    {
        ...
        return ClawbarConfig(version: Self.currentVersion, providers: providers)
    }
