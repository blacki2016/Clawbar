...
public enum ClawbarConfigIssueSeverity: String, Codable, Sendable {
    case warning
    case error
}

public struct ClawbarConfigIssue: Codable, Sendable, Equatable {
    public let severity: ClawbarConfigIssueSeverity
    ...
    public init(
        severity: ClawbarConfigIssueSeverity,
...
public enum ClawbarConfigValidator {
    public static func validate(_ config: ClawbarConfig) -> [ClawbarConfigIssue] {
        var issues: [ClawbarConfigIssue] = []

        if config.version != ClawbarConfig.currentVersion {
            issues.append(ClawbarConfigIssue(
                severity: .error,
                provider: nil,
                field: "version",
    ...
    private static func validateProvider(_ entry: ProviderConfig, issues: inout [ClawbarConfigIssue]) {
