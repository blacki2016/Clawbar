...
struct ClawbarUsageWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: ClawbarWidgetEntry
...
struct ClawbarHistoryWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: ClawbarWidgetEntry
...
struct ClawbarCompactWidgetView: View {
...
struct ClawbarSwitcherWidgetView: View {
    @Environment(\.widgetFamily) private var family
    let entry: ClawbarSwitcherEntry
